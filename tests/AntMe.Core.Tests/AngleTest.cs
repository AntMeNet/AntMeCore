    ...
    public class AngleTest
    {
        ...
        public static IEnumerable<object[]> RadianValues =>
            new[]
            {
                ...
                new object[]
                {
                    -(2 * Math.PI) - 0.001f, 2 * Math.PI - 0.001f, -360, 0, Compass.East
                }, // Close to the negative border
        ...
        /// </summary>
        [Theory]
        [MemberData("RadianValues")]
        public void InitWithFloat(float radian, float normalizedRadian, int degrees, int normalizedDegrees,
            Compass compass)
        {
            // Arrange
        ...
        [Theory]
        [MemberData("RadianValues")]
        public void StaticAngleFromRadian(float radian, float normalizedRadian, int degrees, int normalizedDegrees,
            Compass compass)
        {
            // Arrange

            // Act
            var result = Angle.FromRadian(radian);
        ...
        /// </summary>
        [Theory]
        [MemberData("DegreeValues")]
        public void StaticAngleFromDegree(int degrees, int normalizedDegrees, float radian, float normalizedRadian,
            Compass compass)
        {
            // Arrange

            // Act
            var result = Angle.FromDegree(degrees);
        ...
        [Theory]
        [MemberData("DegreeValues")]
        public void StaticConvertFromDegreeToRadian(int degrees, int normalizedDegrees, float radian,
            float normalizedRadian, Compass compass)
        {
            // Arrange

            // Act
            var result = Angle.ConvertToRadian(degrees);
        ...
        [Theory]
        [MemberData("RadianValues")]
        public void StaticConvertFromRadianToDegree(float radian, float normalizedRadian, int degrees,
            int normalizedDegrees, Compass compass)
        {
            // Arrange

            // Act
            var result = Angle.ConvertToDegree(radian);
        ...
        public void StaticConvertFromDegreeToCompass(int input, Compass expectation)
        {
            ...
            // Act
            var result = Angle.ConvertToCompass(input);
        ...
        [Theory]
        [MemberData("RadianValues")]
        public void StaticNormalizeRadian(float radian, float normalizedRadian, int degrees, int normalizedDegrees,
            Compass compass)
        {
            // Arrange

            // Act
            var result = Angle.NormalizeRadian(radian);
        ...
        [Theory]
        [MemberData("DegreeValues")]
        public void StaticNormalizeDegree(int degrees, int normalizedDegrees, float radian, float normalizedRadian,
            Compass compass)
        {
            // Arrange

            // Act
            var result = Angle.NormalizeDegree(degrees);
        ...
        [Theory]
        [MemberData("RadianValues")]
        public void SetRadianByProperty(float radian, float normalizedRadian, int degrees, int normalizedDegrees,
            Compass compass)
        {
            // Arrange
        ...
        [Theory]
        [MemberData("DegreeValues")]
        public void SetDegreeByProperty(int degrees, int normalizedDegrees, float radian, float normalizedRadian,
            Compass compass)
        {
            // Arrange
            var result = new Angle();
        ...
        {
            // Arrange
            var value = new Angle(init);

            // Act
            var result = value.AddRadian(add);
        ...
        {
            // Arrange
            var value = Angle.FromDegree(init);

            // Act
            var result = value.AddDegree(add);
        ...
        public void SubstractRadianByMethod(float init, float substract, float expectation)
        {
            ...
            // Act
            var result = value.SubstractRadian(substract);
        ...
        public void SubstractDegreeByMethod(int init, int substract, float expectation)
        {
            ...
            // Act
            var result = value.SubstractDegree(substract);
