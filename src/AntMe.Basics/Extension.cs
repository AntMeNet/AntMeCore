...
namespace AntMe.Basics
{
    ...
    public sealed class Extension : IExtensionPack
    {
        ...
        /// </summary>
        public string Description => "Basic Extension with all the Core AntMe! Elements.";

        /// <summary>
        ///     Name of this Extension.
        /// </summary>
        public string Name => "AntMe! Basics";
        ...
        public void Load(ITypeMapper typeMapper, KeyValueStore settings, KeyValueStore dictionary)
        {
            ...
            settings.Set<RecognitionProperty>("SmellsAliance", false,
                "Can a Unit smell Smellable Stuff from Aliance Units");
            settings.Set<RecognitionProperty>("SmellsForeign", false,
                "Can a Unit smell Smellable Stuff from Enemy Units");
            ...
            // Map Tiles
            // ##########################
            typeMapper.RegisterMapTile<ConcaveCliffMapTile, ConcaveCliffMapTileState, ConcaveCliffMapTileInfo>(this,
                "Concave Cliff Map Tile");
            typeMapper.RegisterMapTile<ConvexCliffMapTile, ConvexCliffMapTileState, ConvexCliffMapTileInfo>(this,
                "Convex Cliff Map Tile");
            typeMapper.RegisterMapTile<WallCliffMapTile, WallCliffMapTileState, WallCliffMapTileInfo>(this,
                "Cliff Wall Map Tile");
            typeMapper.RegisterMapTile<LeftRampToCliffMapTile, LeftRampToCliffMapTileState, WallCliffMapTileInfo>(this,
                "Left Ramp To Cliff Wall Map Tile");
            typeMapper.RegisterMapTile<RightRampToCliffMapTile, RightRampToCliffMapTileState, WallCliffMapTileInfo>(
                this, "Right Ramp To Cliff Wall Map Tile");
            ...
            // ##########################
            typeMapper
                .RegisterMapTilePropertySI<WalkableTileProperty, WalkableTileStateProperty, WalkableTileInfoProperty>(
                    this, "Walkable Map Tiles");
            ...
            typeMapper.RegisterItemPropertyS<AppleCollectorProperty, AppleCollectorState>(this,
                "Apple Collector"); // keine Info
            typeMapper.RegisterItemPropertyS<SugarCollectorProperty, SugarCollectorState>(this,
                "Sugar Collector"); // keine Info
            typeMapper.RegisterItemPropertyS<AppleCollectableProperty, AppleCollectableState>(this,
                "Apple Collectable"); // keine Info
            typeMapper.RegisterItemPropertyS<SugarCollectableProperty, SugarCollectableState>(this,
                "Sugar Collectable"); // keine Info
            ...
            typeMapper
                .RegisterFaction<AntFaction, AntFactionState, FactionInfo, AntFactory, AntFactoryInterop, AntUnit,
                    AntUnitInterop, AntItem>(this, "Ants");

            // Ant Factory Interops
            typeMapper.AttachFactoryInteropProperty<AntFactoryInterop, TotalStatisticsInterop>(this,
                "Ant Total Statistics", (f, i) => { return new TotalStatisticsInterop(f, i, typeof(AntItem)); });
            typeMapper.AttachFactoryInteropProperty<AntFactoryInterop, ByTypeStatisticsInterop>(this,
                "Ant By Type Statistics", (f, i) => { return new ByTypeStatisticsInterop(f, i, typeof(AntItem)); });
            typeMapper.AttachFactoryInteropProperty<AntFactoryInterop, ByCasteStatisticsInterop>(this,
                "Ant By Caste Statistics", (f, i) => { return new ByCasteStatisticsInterop(f, i, typeof(AntItem)); });
            ...
            // Bug Faction
            typeMapper
                .RegisterFaction<BugFaction, BugFactionState, FactionInfo, BugFactory, BugFactoryInterop, BugUnit,
                    BugUnitInterop, BugItem>(this, "Bugs");

            // Bug Factory Interops
            typeMapper.AttachFactoryInteropProperty<BugFactoryInterop, TotalStatisticsInterop>(this,
                "Bug Total Statistics", (f, i) => { return new TotalStatisticsInterop(f, i, typeof(BugItem)); });
            typeMapper.AttachFactoryInteropProperty<BugFactoryInterop, ByTypeStatisticsInterop>(this,
                "Bug By Type Statistics", (f, i) => { return new ByTypeStatisticsInterop(f, i, typeof(BugItem)); });
            ...
            typeMapper.AttachFactionProperty<AntFaction, AnthillDeathCounterProperty>(this,
                "Counter for destroyed Anthills");
            ...
            typeMapper.RegisterLevelProperty<DialogHighlightsLevelProperty, DialogHighlightsStateProperty>(this,
                "Dialog Highlights");
            typeMapper.RegisterLevelProperty<MapMarkerHighlightsLevelProperty, MapMarkerHighlightsStateProperty>(this,
                "Map Marker Highlights");
            typeMapper.RegisterLevelProperty<NotificationHighlightsLevelProperty, NotificationHighlightsStateProperty>(
                this, "Notification Highlights");
        }
        ...
        private void RegisterApple(ITypeMapper typeMapper, KeyValueStore settings)
        {
            ...
            {
                var property = new CollidableProperty(i);
            ...
            {
                var property = new VisibleProperty(i);
            ...
            {
                var property = new PortableProperty(i);
            ...
            typeMapper.AttachItemProperty<AppleItem, AppleCollectableProperty>(this, "Apple Collectable", i =>
            {
                ...
                var property = new AppleCollectableProperty(i);
        ...
        private void RegisterSugar(ITypeMapper typeMapper, KeyValueStore settings)
        {
            ...
            // Collectable
            typeMapper.AttachItemProperty<SugarItem, SugarCollectableProperty>(this,
                "Sugar Collectable"); // TODO: Amounts (SugarMaxCapacity, Math.Min(SugarMaxCapacity, amount))
        }
        ...
        private void RegisterAnthill(ITypeMapper typeMapper, KeyValueStore settings)
        {
            ...
            typeMapper.AttachItemProperty<AnthillItem, AttackableProperty>(this, "Anthill Attackable", i =>
            {
                ...
                var property = new AttackableProperty(i);
            ...
            // Collectable
            typeMapper.AttachItemProperty<AnthillItem, SugarCollectableProperty>(this,
                "Anthill Sugarsafe"); // TODO: Radius
            typeMapper.AttachItemProperty<AnthillItem, AppleCollectableProperty>(this,
                "Anthill Applesafe"); // TODO: Radius
        }
        ...
        private void RegisterMarker(ITypeMapper typeMapper, KeyValueStore settings)
        {
            ...
            {
                var property = new SmellableProperty(i);
        ...
        private void RegisterBug(ITypeMapper typeMapper, KeyValueStore settings)
        {
            ...
            {
                var property = new WalkingProperty(i);
            ...
            {
                var property = new SightingProperty(i);
            ...
            {
                var property = new AttackerProperty(i);
        ...
        private void RegisterAnt(ITypeMapper typeMapper, KeyValueStore settings)
        {
            ...
            settings.Set<AntItem>("ClassicBorderBehavior", true,
                "Should an ant be reflected by Walls (like in AntMe! 1)");
            settings.Set<AntItem>("RotationSpeed[-1]", 10,
                "Maximum Rotation Angle per Round (with Speed Attribute -1)");
            ...
            typeMapper.AttachItemProperty<AntItem, WalkingProperty>(this, "Ant Walking", i =>
            {
                ...
                {
                    case -1:
                        maxSpeed = i.Settings.GetFloat<AntItem>("MaxSpeed[-1]").Value;
                        break;
                    case 1:
                        maxSpeed = i.Settings.GetFloat<AntItem>("MaxSpeed[1]").Value;
                        break;
                    case 2:
                        maxSpeed = i.Settings.GetFloat<AntItem>("MaxSpeed[2]").Value;
                        break;
                    default:
                        maxSpeed = i.Settings.GetFloat<AntItem>("MaxSpeed[0]").Value;
                        break;
                }
            ...
            typeMapper.AttachItemProperty<AntItem, CollidableProperty>(this, "Ant Collidable", i =>
            {
                ...
                {
                    case -1:
                        mass = i.Settings.GetFloat<AntItem>("Mass[-1]").Value;
                        break;
                    case 1:
                        mass = i.Settings.GetFloat<AntItem>("Mass[1]").Value;
                        break;
                    case 2:
                        mass = i.Settings.GetFloat<AntItem>("Mass[2]").Value;
                        break;
                    default:
                        mass = i.Settings.GetFloat<AntItem>("Mass[0]").Value;
                        break;
                }
            ...
            typeMapper.AttachItemProperty<AntItem, SightingProperty>(this, "Ant Sighting", i =>
            {
                ...
                if (i.Attributes != null) attentionAttribute = i.Attributes.GetValue("attention");
                ...
                {
                    case -1:
                        viewRange = i.Settings.GetFloat<AntItem>("ViewRange[-1]").Value;
                        break;
                    case 1:
                        viewRange = i.Settings.GetFloat<AntItem>("ViewRange[1]").Value;
                        break;
                    case 2:
                        viewRange = i.Settings.GetFloat<AntItem>("ViewRange[2]").Value;
                        break;
                    default:
                        viewRange = i.Settings.GetFloat<AntItem>("ViewRange[0]").Value;
                        break;
                }
                ...
                {
                    case -1:
                        viewAngle = i.Settings.GetFloat<AntItem>("ViewAngle[-1]").Value;
                        break;
                    case 1:
                        viewAngle = i.Settings.GetFloat<AntItem>("ViewAngle[1]").Value;
                        break;
                    case 2:
                        viewAngle = i.Settings.GetFloat<AntItem>("ViewAngle[2]").Value;
                        break;
                    default:
                        viewAngle = i.Settings.GetFloat<AntItem>("ViewAngle[0]").Value;
                        break;
                }
            ...
            {
                var property = new CarrierProperty(i);
                ...
                {
                    case -1:
                        strength = i.Settings.GetFloat<AntItem>("CarrierStrength[-1]").Value;
                        break;
                    case 1:
                        strength = i.Settings.GetFloat<AntItem>("CarrierStrength[1]").Value;
                        break;
                    case 2:
                        strength = i.Settings.GetFloat<AntItem>("CarrierStrength[2]").Value;
                        break;
                    default:
                        strength = i.Settings.GetFloat<AntItem>("CarrierStrength[0]").Value;
                        break;
                }
            ...
            typeMapper.AttachItemProperty<AntItem, AttackableProperty>(this, "Ant Attackable", i =>
            {
                ...
                // Try to get Attribute Setting
                sbyte defenseAttribute = 0;
                if (i.Attributes != null) defenseAttribute = i.Attributes.GetValue("defense");
                ...
                {
                    case -1:
                        health = i.Settings.GetInt<AntItem>("MaxHealth[-1]").Value;
                        break;
                    case 1:
                        health = i.Settings.GetInt<AntItem>("MaxHealth[1]").Value;
                        break;
                    case 2:
                        health = i.Settings.GetInt<AntItem>("MaxHealth[2]").Value;
                        break;
                    default:
                        health = i.Settings.GetInt<AntItem>("MaxHealth[0]").Value;
                        break;
                }
            ...
            settings.Set<AntItem>("RecoveryTime[-1]", 4,
                "Recovery Time in Rounds for an Ant (with Speed Attribute -1)");
            ...
            settings.Set<AntItem>("AttackMultiplier[-1]", 0.7f,
                "Multiplier for the Attack Strength for an Ant (with Attack Attribute -1)");
            settings.Set<AntItem>("AttackMultiplier[0]", 1f,
                "Multiplier for the Attack Strength for an Ant (with Attack Attribute 0)");
            settings.Set<AntItem>("AttackMultiplier[1]", 1.4f,
                "Multiplier for the Attack Strength for an Ant (with Attack Attribute 1)");
            settings.Set<AntItem>("AttackMultiplier[2]", 1.8f,
                "Multiplier for the Attack Strength for an Ant (with Attack Attribute 2)");
            typeMapper.AttachItemProperty<AntItem, AttackerProperty>(this, "Ant Attacker", i =>
            {
                ...
                {
                    case -1:
                        attackRange = i.Settings.GetFloat<AntItem>("AttackRange[-1]").Value;
                        break;
                    case 1:
                        attackRange = i.Settings.GetFloat<AntItem>("AttackRange[1]").Value;
                        break;
                    case 2:
                        attackRange = i.Settings.GetFloat<AntItem>("AttackRange[2]").Value;
                        break;
                    default:
                        attackRange = i.Settings.GetFloat<AntItem>("AttackRange[0]").Value;
                        break;
                }
                ...
                {
                    case -1:
                        recoveryTime = i.Settings.GetInt<AntItem>("RecoveryTime[-1]").Value;
                        break;
                    case 1:
                        recoveryTime = i.Settings.GetInt<AntItem>("RecoveryTime[1]").Value;
                        break;
                    case 2:
                        recoveryTime = i.Settings.GetInt<AntItem>("RecoveryTime[2]").Value;
                        break;
                    default:
                        recoveryTime = i.Settings.GetInt<AntItem>("RecoveryTime[0]").Value;
                        break;
                }
                ...
                {
                    case -1:
                        attackStrength = i.Settings.GetInt<AntItem>("AttackStrength[-1]").Value;
                        break;
                    case 1:
                        attackStrength = i.Settings.GetInt<AntItem>("AttackStrength[1]").Value;
                        break;
                    case 2:
                        attackStrength = i.Settings.GetInt<AntItem>("AttackStrength[2]").Value;
                        break;
                    default:
                        attackStrength = i.Settings.GetInt<AntItem>("AttackStrength[0]").Value;
                        break;
                }
                ...
                switch (attackAttribute)
                {
                    case -1:
                        attackStrength =
                            (int) (attackStrength * i.Settings.GetFloat<AntItem>("AttackMultiplier[-1]").Value);
                        break;
                    case 1:
                        attackStrength =
                            (int) (attackStrength * i.Settings.GetFloat<AntItem>("AttackMultiplier[1]").Value);
                    ...
                    case 2:
                        attackStrength =
                            (int) (attackStrength * i.Settings.GetFloat<AntItem>("AttackMultiplier[2]").Value);
                        break;
                    default:
                        attackStrength =
                            (int) (attackStrength * i.Settings.GetFloat<AntItem>("AttackMultiplier[0]").Value);
                        break;
                }
            ...
            typeMapper.AttachItemProperty<AntItem, SugarCollectorProperty>(this, "Ant Sugar Collectable", i =>
            {
                ...
                {
                    case -1:
                        capacity = i.Settings.GetInt<AntItem>("SugarCapacity[-1]").Value;
                        break;
                    case 1:
                        capacity = i.Settings.GetInt<AntItem>("SugarCapacity[1]").Value;
                        break;
                    case 2:
                        capacity = i.Settings.GetInt<AntItem>("SugarCapacity[2]").Value;
                        break;
                    default:
                        capacity = i.Settings.GetInt<AntItem>("SugarCapacity[0]").Value;
                        break;
                }

                var property = new SugarCollectorProperty(i);
            ...
            typeMapper.AttachItemProperty<AntItem, AppleCollectorProperty>(this, "Ant Apple Collectable", i =>
            {
                ...
                {
                    case -1:
                        capacity = i.Settings.GetInt<AntItem>("AppleCapacity[-1]").Value;
                        break;
                    case 1:
                        capacity = i.Settings.GetInt<AntItem>("AppleCapacity[1]").Value;
                        break;
                    case 2:
                        capacity = i.Settings.GetInt<AntItem>("AppleCapacity[2]").Value;
                        break;
                    default:
                        capacity = i.Settings.GetInt<AntItem>("AppleCapacity[0]").Value;
                        break;
                }

                var property = new AppleCollectorProperty(i);
                property.Capacity = capacity;
                return property;
