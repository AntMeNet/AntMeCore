...
namespace AntMe.Extension.Basics
{
    public sealed class Extension : IExtensionPack
    {
        ...
        public void Load(ITypeMapper typeMapper, Settings settings)
        {
            ...
            typeMapper.AttachItemProperty<ClassicBugItem, WalkingProperty>(this, "Classic Bug Walking"); // BUG_MAX_SPEED);
            typeMapper.AttachItemProperty<ClassicBugItem, CollidableProperty>(this, "Classic Bug Collidable"); //  BUG_RADIUS);
            //typeMapper.AttachItemProperty<ClassicBugItem, SightingProperty>(this, "Classic Bug Sighting"); // BUG_VIEWRANGE);
            //typeMapper.AttachItemProperty<ClassicBugItem, SnifferProperty>(this, "Classic Bug Sniffer");
            //typeMapper.AttachItemProperty<ClassicBugItem, VisibleProperty>(this, "Classic Bug Visible"); //  BUG_RADIUS);
            ...
            settings.Apply<AppleItem>("MaxAmount", 250);
        }
    }
}
