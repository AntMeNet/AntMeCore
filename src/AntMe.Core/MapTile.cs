...
namespace AntMe
{
    ...
    public abstract class MapTile : PropertyList<MapTileProperty>, ISerializableState
    {
        ...
        private readonly Dictionary<Item, MapTileInfo> infos;
        ...
        protected virtual byte? GetConnectionLevelEast()
        {
            return null;
        }
        ...
        protected virtual byte? GetConnectionLevelSouth()
        {
            return null;
        }
        ...
        protected virtual byte? GetConnectionLevelWest()
        {
            return null;
        }
        ...
        protected virtual byte? GetConnectionLevelNorth()
        {
            return null;
        }
        ...
        /// <param name="exceptions">Result-List of occured Exceptions</param>
        protected virtual bool OnValidateEastSide(MapTile tile, IList<Exception> exceptions)
        {
            return true;
        }
        ...
        /// <param name="tile">Neighbour Tile</param>
        /// <param name="exceptions">Result-List of occured Exceptions</param>
        protected virtual bool OnValidateSouthSide(MapTile tile, IList<Exception> exceptions)
        {
            return true;
        }
        ...
        /// <param name="tile">Neighbour Tile</param>
        /// <param name="exceptions">Result-List of occured Exceptions</param>
        protected virtual bool OnValidateWestSide(MapTile tile, IList<Exception> exceptions)
        {
            return true;
        }
        ...
        /// <param name="tile">Neighbour Tile</param>
        /// <param name="exceptions">Result-List of occured Exceptions</param>
        protected virtual bool OnValidateNorthSide(MapTile tile, IList<Exception> exceptions)
        {
            return true;
        }
