namespace AntMe
{
    ...
    public abstract class FactionItem : Item
    {
        ...
        public FactionItem(SimulationContext context, Faction faction, Vector2 position, float radius,
            Angle orientation)
        ...
        /// <param name="radius">Radius of this Item</param>
        /// <param name="orientation">First Orientation of this Item</param>
        public FactionItem(SimulationContext context, UnitAttributeCollection attributes, Faction faction,
            Vector2 position, float radius, Angle orientation)
