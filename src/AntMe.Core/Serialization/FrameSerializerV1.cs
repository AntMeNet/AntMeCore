...
namespace AntMe.Serialization
{
    ...
    internal sealed class FrameSerializerV1 : IFrameSerializer
    {
        ...
        private byte _factionTypeIndexPointer = 0;
        private byte _itemTypeIndexPointer = 0;
        ...
        {
            _writer.Flush();
            long sizePos = _stream.Position;
            _writer.Write((short)0);
            _writer.Flush();
            long packagePos = _stream.Position;
            serializer(_writer, _version);
            _writer.Flush();
            long endPos = _stream.Position;
            long size = endPos - packagePos;
